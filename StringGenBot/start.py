...
¤¦ تم انشاء البوت بواسطة [ㅤ𓏺 7oda sunni . 🕷 ˼](https://t.me/yg_qo)""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("sᴏᴜʀᴄᴇ ", url="https://t.me/yg_qo1"),
                    InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴩᴇʀ", user_id=1095638828)
                ]
            ]
        ),
